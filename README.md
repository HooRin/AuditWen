...
## GPT_Q&A
Construct a Q&A session on legal and regulatory content through GPT4.0<br>
The gpt4_law_result.xlsx in the directory/AuditWen/GPT_Q&A/data displays regulatory content and content generated by GPT4.<br>
Among them, the audit domain word list is provided at/AuditWen/src/qa_eval/src/Audit Word Table. txt, which is loaded using jieba's load_userdict method
